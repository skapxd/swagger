...
describe('ApiQuery', () => {
    describe('when applied on the class level', () => {
        ...
        TestAppController = __decorate([
            (0, decorators_1.ApiQuery)({ name: 'testId' }),
        ...
        it('should attach metadata to all API methods', () => {
            ...
            expect(Reflect.getMetadata(constants_1.DECORATORS.API_PARAMETERS, controller.get)).toEqual([{ in: 'query', name: 'testId', required: true }]);
        });
